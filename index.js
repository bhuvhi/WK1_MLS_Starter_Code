...
feed.addEventListener("click", event => {
  ...
  // Add functionality to toggle between Like and Unlike when the Like button isclicked, and update the like count accordingly
  if (event.target.tagName === "BUTTON" && (event.target.textContent.includes("Like") || event.target.textContent.includes("Unlike"))) {
    ...
    saveLikes();
    applyFilterAndSort(); // Re-render feed to update like counts and button states
  }
});
